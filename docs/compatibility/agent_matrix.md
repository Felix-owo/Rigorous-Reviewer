...
|---|---|---|---|---|
| Codex `$skill-installer` | Supported | `Use $skill-installer to install https://github.com/Felix-owo/Rigorous-Reviewer/tree/v2.1.3/rigorous-reviewer` | Host imports `SKILL.md`, references, templates, schemas, scripts, examples, and agent metadata. | Run `check_installable_skill.py` locally before release. |

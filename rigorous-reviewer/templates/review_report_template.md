...
**Target field / venue:** <field or journal>

**Manuscript material reviewed:** <main text, figures, methods, supplement, data, code, protocols>

**Reviewer stance:** Comprehensive top-journal-level review.

## 1) Category Scores

- Top-Journal Novelty & Significance: <score>/10 - <brief rationale>
- Domain-Specific Technical Validity: <score>/10 - <brief rationale>
- Logic, Proof & Evidential Support: <score>/10 - <brief rationale>
- Loophole / Alternative-Explanation Control: <score>/10 - <brief rationale>
...
- Classic anchors: <landmark papers, standards, datasets, theorems, trials, benchmarks>
- Canonical methods and evidence thresholds: <required controls, characterization, proof standards, cohorts, benchmarks, reporting standards>
...
- Method and logic calibration: <what comparable anchors imply about rigor>
...
- Domain Reviewer: <main field judgment>
- Interdisciplinary Reviewer: <main bridge-claim judgment>
...
- [Critical/Major/Minor] <short title>
  ...
  为什么严重：<domain-specific reason this threatens the claim; use 为什么重要 for Minor clarity/reporting issues when appropriate>
  证据：
  - 稿件内部证据：<figure/panel/table/claim/method/proof/data/code/source or stated omission>
  - 外部证据/标准：<primary paper / guideline / benchmark / theorem source / standard / DOI/PMID/arXiv/link>
  影响：<what becomes unsupported, overclaimed, ambiguous, non-reproducible, or vulnerable to false-positive interpretation>
  替代解释/漏洞：<confounders, artifacts, hidden assumptions, leakage, edge cases, off-targets, systematics, boundary cases>
...
- Search strings: <2-4 targeted queries>
...
- Target: <figure/table/section/model/proof/experiment/cohort/benchmark>
- Required revision: <specific experiment, analysis, control, validation, proof repair, characterization, statistics, code/data release, or rewrite>
- Minimum acceptable readout: <quantitative or qualitative threshold>
- Rationale with evidence: <why this is necessary and which source sets the bar>
- Consequence if unresolved: <claim must be narrowed / remains unsupported / rejection-level gap>

### Important but not decisive

- Target: <figure/table/section/model/proof/experiment/cohort/benchmark>
- Required revision: <specific bounded revision>
- Minimum acceptable readout: <threshold>
- Rationale with evidence: <source-backed rationale>
- Consequence if unresolved: <remaining limitation>
...
- Required claim narrowing if the bar is not met: <specific conclusion to weaken/remove/relabel>

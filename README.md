...
[![Version](https://img.shields.io/badge/Version-v2.1.3-blue.svg)](CHANGELOG.md)
...
```text
Use $skill-installer to install https://github.com/Felix-owo/Rigorous-Reviewer/tree/v2.1.3/rigorous-reviewer
```
...
python "${CODEX_HOME:-$HOME/.codex}/skills/.system/skill-installer/scripts/install-skill-from-github.py" \
  --url https://github.com/Felix-owo/Rigorous-Reviewer/tree/v2.1.3/rigorous-reviewer
```
...
Use the release tag `v2.1.3` for reproducible installs. Use the `main` branch
...
```text
Rigorous Reviewer v2.1.3. A portable Agent Skill for scientific peer review.

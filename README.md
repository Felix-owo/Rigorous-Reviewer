...
```text
Use $skill-installer to install https://github.com/Felix-owo/Rigorous-Reviewer/tree/v2.0.0/rigorous-reviewer
```
...
python "${CODEX_HOME:-$HOME/.codex}/skills/.system/skill-installer/scripts/install-skill-from-github.py" \
  --url https://github.com/Felix-owo/Rigorous-Reviewer/tree/v2.0.0/rigorous-reviewer
```
...
Use the release tag `v2.0.0` for reproducible installs. Use the `main` branch
...
python rigorous-reviewer/scripts/lint_structured_review.py tests/fixtures/json/valid_structured_review.json
...
```text
Rigorous Reviewer v2.0.0. A portable Agent Skill for scientific peer review.

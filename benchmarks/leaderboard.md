...
| v2.3.1 | v1.1-public | PASS | No | N/A | N/A | Clean replacement release from v2.1.3 baseline with MPL-2.0, traceability modules, and release metadata validation. |
...
python rigorous-reviewer/scripts/score_benchmark_semantic.py \
  ...
  --outputs-dir outputs \
  --json > benchmarks/results/v2.3.1_public_outputs.json
```
